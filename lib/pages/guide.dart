...
import 'package:campus_locate_me/utils/convert_map_icon.dart';
import 'package:campus_locate_me/utils/map_util.dart';
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
            Text('Steps', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 18),) ,
            Container(
                    margin: EdgeInsets.only(top: 8, bottom: 8),
                    height: 3,
                    width: 70,
